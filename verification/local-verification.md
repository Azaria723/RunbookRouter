...
- Direct Mode contract suite: `10 passed`.
...
- Adversarial coverage: fetched-byte digest mismatch, unverified candidate exclusion, nonexistent selection, out-of-vocabulary action/class, wrong roles, invalid order, invalid service configuration and protected-state preservation.
